...
function main_function()
    ...
    % Debug: Print the number of selected and obfuscated nodes
    ...
    plot(obfuscated_longitude, obfuscated_latitude, 'bs', 'MarkerFaceColor', 'b'); % Highlight obfuscated nodes
    grid on;
    hold off;
...
function [col_osmid_selected, original_longitude, original_latitude] = node_in_target(col_longitude, col_latitude, col_osmid, TARGET_LON_MAX, TARGET_LON_MIN, TARGET_LAT_MAX, TARGET_LAT_MIN)
    ...
    % Select only the first ten values if available
