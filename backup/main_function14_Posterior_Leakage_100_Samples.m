...
function main_function() 
    ...
    % Compute posterior probabilities (main value)
    posterior_probabilities_main = compute_posterior_probabilities(locations, raw_distance_matrix, noisy_distance_matrix);

    % Compute 100 samples of noisy_distance_matrix and their posterior probabilities
    num_samples = 100;
    ...
    for sample_idx = 1:num_samples
        ...
        posterior_probabilities_sample = compute_posterior_probabilities(locations, raw_distance_matrix, noisy_distance_sample);
    ...
    % Display results
    disp('Main Posterior Probabilities:');
