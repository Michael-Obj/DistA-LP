...
for numIntervals = 1:12
    ...
    [quantized_matrices, perms] = align_matrices_rowwise(aligned_raw_distance_matrices, 100);
    
    


    % This line of code is from chatgpt but giving high PL value
    % [quantized_matrices, row_perms] = align_matrices_rowonly(aligned_raw_distance_matrices, 100, 1e-10);
