function env_parameters = readGridMapInfo(env_parameters)
    opts = detectImportOptions('./dataset/city_rome_grid/reget_rome_cell_node40x40.csv');
    opts = setvartype(opts, 'osmid', 'int64');
    df_nodes = readtable('./dataset/city_rome_grid/reget_rome_cell_node40x40.csv', opts);
    df_edges = readtable('./dataset/city_rome_grid/reget_rome_cost_thrhold_2.csv');
