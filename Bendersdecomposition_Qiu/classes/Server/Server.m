classdef Server
    ...
    methods
        ...
        %% Function: Create the obfuscation matrix
        function [this, user, iter, cost, cost_test] = geo_obfuscation_generator(this, user, env_parameters)
            ...
            while iter < 100
                ...
                for m = 1:1:size(user, 1)
                    ...
                    % this.subproblem(m, 1).cost
                    % this.subproblem(m, 1).cost_current
                    % cost_upperbound(iter) - cost_lowerbound(iter)
                end
