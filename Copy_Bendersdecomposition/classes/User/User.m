classdef User
    ...
    methods
        ...
        function this = obf_identifier(this, env_parameters)
            ...
            target_count = ceil(0.0025 * env_parameters.nr_loc_selected);     
        ...
        function this = gaussian_recover(this, env_parameters)
            ...
            A1_hat = max(A1_hat, 0);
            A1_hat = 0.5*(A1_hat + A1_hat');
            A1_hat(1:size(A1_hat,1)+1:end) = 0;
            A1_hat = project_metric(A1_hat);  % Floyd–Warshall projection

            this.distance_matrix_LR_recovered     = A1_hat; 
            this.distance_matrix_LR2obf_recovered = project_rectangular_triangle_tighten(A1_hat, A2_hat, 2);
        ...
        function this = RBF_recover(this, env_parameters)
            ...
            A1_hat_r = max(A1_hat_r, 0);
            A1_hat_r = 0.5*(A1_hat_r + A1_hat_r');
            A1_hat_r(1:size(A1_hat_r,1)+1:end) = 0;
            A1_hat_r = project_metric(A1_hat_r);  % Floyd–Warshall projection

            this.distance_matrix_LR_recovered_r     = A1_hat_r;  
            this.distance_matrix_LR2obf_recovered_r = project_rectangular_triangle_tighten(A1_hat_r, A2_hat_r, 2);
