...
EPSILON = 1;  % EPSILON value for noise
...
for i = 1:num_locations
    % Select the CARDINALITY_N - 1 nearest neighbors to point i
...
% [aligned_raw_distance_matrices, perms] = align_matrices_rowwise(raw_distance_matrices, 100);
...
for numIntervals = 1:12
    ...
    % [quantized_matrices, best_pi] = align_user_matrix_A1(aligned_raw_distance_matrices);

    [quantized_matrices, row_perms, col_perms] = align_square_matrices(aligned_raw_distance_matrices);
    ...
    for i = 1:num_locations    
        for sample_idx = 1:num_samples
            ...
            noisy_distance_sample = add_noise_to_distance_matrix(quantized_matrices{i}, EPSILON);  
