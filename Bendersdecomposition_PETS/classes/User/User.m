classdef User
    ...
    methods
        ...
        function this = initialization(this, env_parameters)
            ...
            this = this.noisy_parameters(env_parameters);                   % Calculate noisy parameters, ??Michael 
        ...
        function this = obf_identifier(this, env_parameters)
            ...
            target_count = ceil(0.2 * env_parameters.nr_loc_selected);     
        ...
        function this = cost_matrix_whole_cal(this, env_parameters)
            ...
            for i = 1:1:this.LR_loc_size
                ...
                [~, distance] = shortestpathtree(env_parameters.G, this.LR_loc_ID(i));
                this.cost_matrix_whole(i, :) = min(999999, distance(:))'; 
            end
        end
        ...
        function this = noisy_parameters(this, env_parameters)
            % this.noisy_distance_sample_1 = cell(this.LR_loc_size, this.LR_sample_size);
            % this.noisy_distance_sample_2 = cell(this.LR_loc_size, this.LR_sample_size);
            % this.noisy_distance_sample_3 = cell(this.LR_loc_size, this.LR_sample_size);

            % for i = 1:this.LR_loc_size
                % for sample_idx = 1:this.LR_sample_size
                    this.n_fitted_best_params_1 = add_noise_to_distance_matrix(this.fitted_best_params_1, this.epsilon);
                    this.n_fitted_best_params_2 = add_noise_to_distance_matrix(this.fitted_best_params_2, this.epsilon);
                    this.n_fitted_best_params_3 = add_noise_to_distance_matrix(this.fitted_best_params_3, this.epsilon);


                    % this.distance_matrix = compute_distance_matrix(env_parameters.latitude_selected, env_parameters.longitude_selected);
                    % [~, ~, PL_max_1(1, 1)] = compute_log_posterior(this.fitted_best_params_1, this.n_fitted_best_params_1, this.distance_matrix_LR, size(this.distance_matrix_LR,1), 1/this.epsilon, size(this.distance_matrix_LR,1)); 
                    % average_posterior_leakage_1 = mean(max(PL_max_1(1, :)));
                    % [~, ~, PL_max_2(1, 1)] = compute_log_posterior(this.fitted_best_params_2, this.n_fitted_best_params_2, this.distance_matrix_LR, size(this.distance_matrix_LR,1), 1/this.epsilon, size(this.distance_matrix_LR,1)); 
                    % average_posterior_leakage_2 = mean(max(PL_max_2(1, :)));
                    % [~, ~, PL_max_3(1, 1)] = compute_log_posterior(this.fitted_best_params_3, this.n_fitted_best_params_3, this.distance_matrix_LR, size(this.distance_matrix_LR,1), 1/this.epsilon, size(this.distance_matrix_LR,1)); 
                    % average_posterior_leakage_3 = mean(max(PL_max_3(1, :)));


                    this.n_fitted_best_coeffs_1 = add_noise_to_distance_matrix(this.fitted_best_coeffs_1, this.epsilon);
                    this.n_fitted_best_coeffs_2 = add_noise_to_distance_matrix(this.fitted_best_coeffs_2, this.epsilon);
                    this.n_fitted_best_coeffs_3 = add_noise_to_distance_matrix(this.fitted_best_coeffs_3, this.epsilon);

                    this.n_fitted_best_w_1 = add_noise_to_distance_matrix(this.fitted_best_w_1, this.epsilon);
                    this.n_fitted_best_w_2 = add_noise_to_distance_matrix(this.fitted_best_w_2, this.epsilon);
                    this.n_fitted_best_w_3 = add_noise_to_distance_matrix(this.fitted_best_w_3, this.epsilon);

                    this.n_fitted_best_factors_1 = add_noise_to_distance_matrix(this.fitted_best_factors_1, this.epsilon);
                    this.n_fitted_best_factors_2 = add_noise_to_distance_matrix(this.fitted_best_factors_2, this.epsilon);
                    this.n_fitted_best_factors_3 = add_noise_to_distance_matrix(this.fitted_best_factors_3, this.epsilon);
        ...
        function this = gaussian_recover(this, env_parameters)
            ...
            this.distance_matrix_LR2obf_recovered_s = A2_hat_s;
