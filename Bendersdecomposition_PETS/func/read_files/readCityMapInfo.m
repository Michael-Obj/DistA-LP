function env_parameters = readCityMapInfo(env_parameters)
    ...
    env_parameters.node_target          = [];
    env_parameters.longitude            = [];
    env_parameters.latitude             = [];
    env_parameters.longitude_selected   = [];
    env_parameters.latitude_selected    = [];
    env_parameters.node_target_selected = [];
    env_parameters.G                    = [];
    ...
    env_parameters.longitude_raw_min = env_parameters.longitude_min;
    env_parameters.longitude_raw_max = env_parameters.longitude_max; 
    env_parameters.latitude_raw_min = env_parameters.latitude_min; 
    env_parameters.latitude_raw_max = env_parameters.latitude_max; 
    ...
    % save("location_node_target.mat", "node_tar", "lon_sel", "lat_sel");
end