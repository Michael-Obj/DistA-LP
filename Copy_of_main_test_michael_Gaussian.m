...
S = load('Bendersdecomposition_PETS/rome_location_data/location_data_sample_1/location_data_r1_user1.mat', ...
...
R = load('Bendersdecomposition_PETS/rome_location_data/location_data_sample_1/location_data_r1_user1.mat','LR_ID');
original_longitude = S.lon_sel(R.LR_ID);
original_latitude  = S.lat_sel(R.LR_ID);
...
target_long = col_longitude_selected(1);
target_lat  = col_latitude_selected(1);
...
EPSILON = 10;  % EPSILON value for noise
