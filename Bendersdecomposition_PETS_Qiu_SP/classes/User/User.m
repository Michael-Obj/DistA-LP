classdef User
    ...
    methods
        ...
        function this = apply_gaussian(this)
            this.distance_matrix_LR = this.distance_matrix_LR_recovered; 
            this.distance_matrix_LR2obf = this.distance_matrix_LR2obf_recovered; 
            this.cost_matrix_RL = this.cost_matrix_RL_recovered;
        end
        ...
        function this = obf_identifier(this, env_parameters)
            ...
            target_count = ceil(0.01 * env_parameters.nr_loc_selected);     
