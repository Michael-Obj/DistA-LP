%% Original centralized metric-DP LP baseline runner
% Run from the baseline artifact root. The implementation contains every
% pairwise metric-DP constraint and is not expected to scale to N >= 2000.
...
lp_results = run_optimization_baseline('LP', config);
